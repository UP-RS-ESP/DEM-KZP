...
kp_magnitude_filter_option = 0; % DEFAULT OPTION (m)
...
kp_relief_filter_option = 1; % (m) Intuitive option, simply filters 
...
KZ_calib_easting_column_num = 10; 
...
KZ_calib_northing_column_num = 11; 
...
calibration_snapping_tolerance = 50; % (m) % 30m for 30m DEMs
...
SG_smoothing_calib = [11 51 101 151]; % sgolay smoothing window size (cells)
...
min_kp_size1_calib = [0.25 0.5 0.75 1]; 
