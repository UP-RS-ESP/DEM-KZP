function DEM_mkfigures(MATLABV, PaperType_size, quality_flag, DEM_basename_nodir, ...
    ...
    AOI_ridgecrest_DEM, AOI_ridgecrest_MS_deltay_all, AOI_ridgecrest_MS_yi_all, ridgecrest_stepsize)
...
if exist(dem_plot_fname, 'file') ~= 2
    ...
    grid on
    for i = 1:length(AOI_ridgecrest_MS)
        scatter(AOI_ridgecrest_MS(i).x(AOI_ridgecrest_MS(i).deltay_lg_1std), ...
            AOI_ridgecrest_MS(i).y(AOI_ridgecrest_MS(i).deltay_lg_1std), ...
            abs(AOI_ridgecrest_MS(i).deltay(AOI_ridgecrest_MS(i).deltay_lg_1std).*1000), ...
            AOI_ridgecrest_MS(i).deltay(AOI_ridgecrest_MS(i).deltay_lg_1std))
    end
    ylabel('UTM-Northing (m)', 'Fontsize', 12);
    xlabel('UTM-Easting (m)', 'Fontsize', 12);
    ...
    grid on
    for i = 1:length(AOI_ridgecrest_MS)
        scatter(AOI_ridgecrest_MS(i).x(AOI_ridgecrest_MS(i).deltay_lg_2std), ...
            AOI_ridgecrest_MS(i).y(AOI_ridgecrest_MS(i).deltay_lg_2std), ...
            abs(AOI_ridgecrest_MS(i).deltay(AOI_ridgecrest_MS(i).deltay_lg_2std).*1000), ...
            AOI_ridgecrest_MS(i).deltay(AOI_ridgecrest_MS(i).deltay_lg_2std))
    end
    ylabel('UTM-Northing (m)', 'Fontsize', 12);
    xlabel('UTM-Easting (m)', 'Fontsize', 12);
