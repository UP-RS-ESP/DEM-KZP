function csvwrite_with_headers(filename,m,headers,precision,r,c)
% This file has been modified by B. Bookhagen from:
% http://www.mathworks.com/matlabcentral/fileexchange/29933-csv-with-column-headers
%
...
%   precision   - numbers of significant digits, precision string, e.g.,
%                 '%.6f' or a scalar that indicates number of significant digits
...
%
dlmwrite(filename, m,'-append','delimiter',',','roffset', r,'coffset',c, 'precision', precision);
