...
for k = 1:length(KZP_parameters.stream_order)
    ...
    if exist(strcat(sprintf('%s%sSTO%s', KZP_parameters.shapefile_dirname, KZP_parameters.dir_sep, KZP_parameters.dir_sep), AOI_STO_dbasins_stats_CNTR_csv_fname), 'file') == 2 && ...
            exist(strcat(sprintf('%s%sSTO%s', KZP_parameters.shapefile_dirname, KZP_parameters.dir_sep, KZP_parameters.dir_sep), AOI_STO_dbasins_stats_OUT_csv_fname), 'file') == 2
        continue
    end
    ...
    if exist('AOI_STO_N_unique', 'var') ~= 1
        ...
        if exist(strcat(sprintf('%s%sSTO%s', KZP_parameters.shapefile_dirname, KZP_parameters.dir_sep, KZP_parameters.dir_sep), AOI_STO_dbasins_stats_OUT_csv_fname), 'file') ~= 2
        ...
        if exist(strcat(sprintf('%s%sSTO%s', KZP_parameters.shapefile_dirname, KZP_parameters.dir_sep, KZP_parameters.dir_sep), db_stats_shapeout_fn), 'file') ~= 2
            ...
            eval([KZP_parameters.mv_cmd, ' ', db_stats_shapeout_all_fn, ' ', sprintf('%s%sSTO%s', KZP_parameters.shapefile_dirname, KZP_parameters.dir_sep, KZP_parameters.dir_sep)]);
            eval([KZP_parameters.remove_cmd, ' ', sprintf('%s%sSTO%s%s', KZP_parameters.shapefile_dirname, KZP_parameters.dir_sep, KZP_parameters.dir_sep, db_stats_crt_fn)]);
        end
