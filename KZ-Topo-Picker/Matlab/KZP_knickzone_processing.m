...
%
% Code developed by Al Neely and Bodo Bookhagen (bodo.bookhagen@uni-potsdam.de) on 
% 10/12/2015, significantly modified March-May 2016, May 2017
%
% The code has been tested with Matlab R2012b, R2014b, R2015b, and R2016a. 
...
% _gdal_polygonize_.
%
% 5. Install the _KnickZone-Picker_ (KZP) code and subdirectories and add
% the KPP directory to the Matlab PATH.
%
%
% This Matlab code takes MAT file written by
% _KKZP_parameters_1m.m_ and calculates knickpoints and
