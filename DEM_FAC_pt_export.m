function DEM_FAC_pt_export(AOI_DEM, AOI_FAC, AOI_FAC_pt_threshold, AOI_FD, ...
...
shapeout_fn = sprintf('shapefiles%s%s_PT_%s.shp', dir_sep, ...
    DEM_basename, num2str(AOI_FAC_pt_threshold,'%1.0G'));
shapeout_fn_out = sprintf('shapefiles%s%s_PT_%s.out', dir_sep, ...
    DEM_basename, num2str(AOI_FAC_pt_threshold,'%1.0G'));
shapeout_all_fn = sprintf('shapefiles%s%s_PT_%s.*', dir_sep, ...
    DEM_basename, num2str(AOI_FAC_pt_threshold,'%1.0G'));
...
shapeout_fn_prj = sprintf('shapefiles%s%s_%s_PT_proj.shp', ...
    dir_sep, DEM_basename, num2str(AOI_FAC_pt_threshold,'%1.0e'));
